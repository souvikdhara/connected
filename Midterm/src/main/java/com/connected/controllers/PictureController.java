...
public class PictureController {
	...
	public String makeProfilePicture(@PathVariable Long pictureId, @RequestParam("anchor") int anchor,
	...
	public String updateProfilePicture(HttpServletRequest httpServletRequest,
