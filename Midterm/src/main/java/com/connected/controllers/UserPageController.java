...
public class UserPageController {
	...
	public String deleteFollowerFollowing(@RequestParam("accountId") Long accountId,
			@PathVariable("profileString") String profileString) {
		accountService.deleteFollowerFollowing(accountId,
				accountService.getCurrentUserAccountIfAuthenticated().getId());
		return "redirect:/" + profileString;
	}

	@PostMapping("/{profileString}/follow")
	public String saveFollowerFollowing(@RequestParam("accountId") Long accountId,
			@PathVariable("profileString") String profileString) {
