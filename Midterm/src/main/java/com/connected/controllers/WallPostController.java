...
import com.connected.services.PictureService;
...
public class WallPostController {
	...
	public String wallPostPage(Model model, @PathVariable("wallPostId") Long wallPostId,
	...
	public String deleteWallpost(@PathVariable Long wallpostId, @RequestParam("anchor") int anchor,
	...
	public String addLike(@RequestParam("likedWallPost") Long likedWallPost, @RequestParam("anchor") int anchor,
			HttpServletRequest httpServletRequest) {
	...
	public String newWallPost(HttpServletRequest httpServletRequest, @RequestParam("message") String message,
			@RequestParam("postImage") MultipartFile image, @RequestParam("parentPost") Long parentPostId)
			throws IOException {
		WallPost parentPost;
