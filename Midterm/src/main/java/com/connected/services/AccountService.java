...
import com.connected.domain.FollowingFollower;
import com.connected.domain.FollowingFollowerKey;
import com.connected.repositories.AccountRepository;
import com.connected.repositories.FollowingFollowerRepository;
import com.connected.userDetails.ConnectedUserDetails;
...
public class AccountService {
	...
	public Account getCurrentUserAccountIfAuthenticated() {
		try {
			...
			ConnectedUserDetails currentUserDetails = (ConnectedUserDetails) auth.getPrincipal();
